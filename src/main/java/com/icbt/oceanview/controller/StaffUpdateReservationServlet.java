...
@WebServlet("/staff/reservation/update")
public class StaffUpdateReservationServlet extends HttpServlet {
    ...
    if (updated) {
      response.sendRedirect(
          request.getContextPath()
              + "/staff/reservations?success=Reservation+updated+successfully.");
    } else {
